...
const ScrollingTestimonials: React.FC<{ testimonials: CommentData[] }> = ({
  ...
  return (
    <div className="3xl:max-w-[1440px] mx-auto mt-20 overflow-hidden py-12 sm:mt-24 sm:py-16 lg:max-w-[1100px]">
      <SectionHeading
        heading="Loved by Thousands of People"
        subheading="Here's what some of my viewers have to say about Nikolay Todorov"
      />
      <div className="relative">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          {/* Mobile view: single column */}
          <div className="marquee-slow h-[460px] overflow-hidden px-6 sm:h-[520px] sm:px-10 md:hidden">
          ...
          {[group1, group2, group3].map((group, index) => (
            <div
              key={index}
              className={`hidden h-[520px] overflow-hidden md:block ${
